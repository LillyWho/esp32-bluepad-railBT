...
// CV 2 	Start Volts (Vstart / "Boost") -- This offsets the motor duty cycle to something higher. We use a percentage from 0 to 10.
// CV 3 	Acceleration Rate
// CV 4 	Deceleration Rate
// CV 5 	Top Volts (Vhigh / Limit) -- Use this to throttle the duty cycle. All speed inputs will scale between CV 2 and this one.